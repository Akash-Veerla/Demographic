...
const Register = () => {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center bg-background-light dark:bg-background-dark font-display antialiased py-10">
            ...
            <div className="relative z-10 w-full max-w-[460px] mx-4 bg-white/10 dark:bg-white/5 backdrop-blur-2xl shadow-2xl p-8 md:p-10 flex flex-col animate-fade-in-up border-[0.5px] border-white/30 dark:border-white/10 mb-8" style={{ borderRadius: '28px' }}>
