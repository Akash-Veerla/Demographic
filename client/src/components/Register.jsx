    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center bg-background-light dark:bg-background-dark font-display antialiased overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
             ...
             <div className="relative z-10 w-full max-w-[460px] mx-4 bg-surface dark:bg-[#2c1b19] shadow-2xl p-8 md:p-10 flex flex-col animate-fade-in-up" style={{ borderRadius: '28px' }}>
                ...
                <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[#1a100f] dark:text-white text-sm font-semibold ml-1">Full Name</label>
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[#1a100f] dark:text-white text-sm font-semibold ml-1">Password</label>
                        <div className="relative group">
                            <input
                                name="password"
                                type="password"
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[#1a100f] dark:text-white text-sm font-semibold ml-1">Confirm Password</label>
                        <div className="relative group">
                            <input
                                ...
                                style={{ borderRadius: '12px' }}
                            />
                            <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-[#915b55] group-focus-within:text-primary transition-colors text-[20px]">lock_reset</span>
                        </div>
                    </div>
                    <button
                        type="submit"
